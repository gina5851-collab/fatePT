...
export const REPORT_TIERS: ReportTier[] = [
  ...
  // 본상품 (34,900원) — premium-saju "나의 전체 흐름 리포트" 와 매핑.
  // 운영 DB 와 동기화 필요 (사용자가 UPDATE 예정). 정가/취소선(originalPrice) 표기는 광고법 위험으로 제거.
  { id: "full", productSlug: "premium-saju", price: 34900, label: "나의 전체 흐름 리포트", sub: "타고난 기질·관계·돈·일까지 6섹션 전체", highlight: true },
