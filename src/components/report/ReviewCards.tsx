...
const REVIEWS = [
  { tag: "#불안했는데", emotion: "불안해서 들어왔는데 마음이 놓였어요", body: "뭔가 잘못된 줄 알고 떨면서 봤는데, 읽고 나니 '아 내가 그동안 너무 버텼구나' 싶어서 오히려 위로받았어요." },
  { tag: "#팩폭", emotion: "팩폭인데 기분이 안 나빴어요", body: "정확하게 짚는데 이상하게 기분이 안 상해요. 혼내는 게 아니라 설명해주는 느낌이라 그런가 봐요." },
  { tag: "#무료랑다름", emotion: "무료 테스트랑 확실히 달랐어요", body: "다른 데 무료 사주는 '좋은 기운이 와요~' 이런 건데, 여긴 제 반복 패턴을 콕 짚어줘서 소름." },
  { tag: "#돈값", emotion: "길긴 한데 돈값 했어요", body: "분량 많아서 출퇴근에 나눠 읽었는데, 다 읽고 나니 결제한 거 안 아까웠어요." },
  { tag: "#해석", emotion: "평가가 아니라 해석해주는 느낌", body: "나를 점수 매기는 게 아니라, 왜 그랬는지 풀어줘서 계속 읽게 돼요." },
];
